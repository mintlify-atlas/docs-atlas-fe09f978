...
<CardGroup cols={2}>
  <Card title="Props Reference" icon="book" href="/props">
    Explore all available props and customization options
  </Card>
  
  <Card title="Callbacks & Events" icon="bolt" href="/callbacks">
    Learn about event handlers and lifecycle callbacks
  </Card>
  
  <Card title="Helper Functions" icon="wrench" href="/helpers">
